...
<body >
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right"> 
              ...
              $res = $mydb->loadSingleResult(); 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Hi, <?php echo $singleuser->ACCOUNT_NAME; ?>


                            <?php if ($_SESSION['ACCOUNT_TYPE']=='Officer') {
                              # code...
                              echo '<img width="23px" height="17px" src="'.web_root.'/student/'.$res->STUDPHOTO.'" />';
                            }else{ ?> 
                                <img title="profile image" width="23px" height="17px" src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>">  
                          <?php   } ?>
   ...
   <!-- /input-group -->
                      ...
                      <?php if ($_SESSION['ACCOUNT_TYPE']=='Administrator') {  ?>
                      <li>
                             <a href="<?php echo web_root; ?>admin/instructor/index.php" ><i class="fa fa-users fa-fw"></i> Manage Instructor  </a>
